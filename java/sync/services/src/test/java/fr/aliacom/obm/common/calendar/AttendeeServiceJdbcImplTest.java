...
public class AttendeeServiceJdbcImplTest {
	...
	public void setUp() {
		...
		contactDao = createMockBuilder(ContactDao.class)
				.withConstructor(ContactConfiguration.class, CalendarDao.class, SolrHelper.Factory.class, ObmHelper.class)
				.withArgs(contactConfiguration, calendarDao, solrHelperFactory, obmHelper)
