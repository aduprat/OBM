...
public class UserSettings {
	...
	public Locale locale() {
		String localeAsString = MoreObjects.firstNonNull(rawSettings.get("set_lang"), "en");
		return new Locale(localeAsString);
	}
	
	public boolean expectParticipationEmailNotification() {
		String value = 
				MoreObjects.firstNonNull(rawSettings.get("set_mail_participation"), "yes");
	...
	public TimeZone timezone() {
		String timezoneAsString = MoreObjects.firstNonNull(rawSettings.get("set_timezone"), "GMT");
