...
public class HistoryDtoTest {
	...
	public void fromListArchiveTreatmentsShouldCopyElements() {
		...
		assertThat(archiveTreatmentDto.scheduledTime).isEqualTo(DateUtils.date("2014-09-05T14:10:00.000Z"));
		assertThat(archiveTreatmentDto.startTime).isEqualTo(DateUtils.date("2014-09-05T14:10:05.000Z"));
		assertThat(archiveTreatmentDto.endTime).isEqualTo(DateUtils.date("2014-09-05T14:10:10.000Z"));
		assertThat(archiveTreatmentDto.higherBoundary).isEqualTo(DateUtils.date("2014-08-05T14:10:00.000Z"));
