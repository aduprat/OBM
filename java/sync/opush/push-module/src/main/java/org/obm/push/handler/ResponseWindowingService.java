...
public class ResponseWindowingService {
	...
	public DataDelta windowedResponse(SyncCollection c, DataDelta delta, SyncClientCommands clientCommands, SyncKey newSyncKey) {
	...
	@VisibleForTesting List<ItemChange> windowChanges(SyncCollection c, final SyncKey newSyncKey, DataDelta delta,
	...
	@VisibleForTesting List<ItemDeletion> windowDeletions(final SyncCollection c, final SyncKey newSyncKey, DataDelta delta, SyncClientCommands clientCommands) {
		final SyncKey syncKey = c.getSyncKey();
