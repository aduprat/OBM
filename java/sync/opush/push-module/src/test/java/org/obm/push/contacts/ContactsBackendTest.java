...
public class ContactsBackendTest {
	...
	public void testGetChanges() throws Exception {
		...
		SyncCollection collection = new SyncCollection(collectionId, COLLECTION_CONTACT_PREFIX);
		...
		mocks.replay();
		DataDelta dataDelta = contactsBackend.getAllChanges(userDataRequest, lastKnownState, collection, newSyncKey);
		mocks.verify();
